...
### Documentación
- docs/session_5/session_5_start_here.md — onboarding de 5 minutos con comandos esenciales.
- docs/session_5/session_5_readme_improved.md — guía operativa completa y troubleshooting.
- docs/session_5/session_5_architecture.md — arquitectura de cinco capas y flujos JWT documentados.
- docs/session_5/session_5_debugging_guide.md — catálogo de siete incidencias frecuentes y scripts curl.
- docs/session_5/session_5_summary.md — resumen narrativo con métricas y checklist de la sesión.
- docs/session_5/session_5_release_notes_v1.1.0.md — detalle de commits, métricas y riesgos del release.
- docs/session_5/session_5_file_manifest_v1.1.0.md — inventario de rutas (este documento).
...
- Variables sensibles gestionadas vía `.env`; guía de uso en session_5_readme_improved.md.
...
- [x] Credenciales de prueba validadas y documentadas en session_5_summary.md.
