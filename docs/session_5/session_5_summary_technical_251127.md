...
|-----------|-----------|-----------------|
| [session_5_start_here_251127.md](./session_5_start_here_251127.md) | Onboarding exprés | Objetivo del proyecto, comandos esenciales, credenciales de prueba |
| [session_5_readme_improved_251127.md](./session_5_readme_improved_251127.md) | Guía operativa | Requisitos de entorno, despliegue con Docker, troubleshooting |
| [session_5_summary_251127.md](./session_5_summary_251127.md) | Resumen narrativo | Objetivos logrados, métricas de sesión, checklist de cierre |
| [session_5_architecture_251127.md](./session_5_architecture_251127.md) | Diseño técnico | Capas del backend, estructura del frontend, diagramas de flujos |
| [session_5_debugging_guide_251127.md](./session_5_debugging_guide_251127.md) | Resolución de errores | 7 incidencias frecuentes, guías de logging, verificación de servicios |
| [session_5_overview_251127.md](./session_5_overview_251127.md) | Visión ejecutiva | KPIs de autenticación, alcance cubierto, riesgos mitigados |
| [session_5_documentation_complete_251127.md](./session_5_documentation_complete_251127.md) | Meta-documento | Inventario de referencias, decisiones de documentación, backlog |
| [session_5_file_manifest_v1.1.0_241126.md](./session_5_file_manifest_v1.1.0_241126.md) | Inventario de archivos | Tabla de rutas, tamaño y responsable de cada entrega |
...
1. session_5_start_here_251127.md
2. session_5_summary_251127.md
3. session_5_readme_improved_251127.md

**90 minutos — Visión técnica completa**
1. session_5_architecture_251127.md
2. session_5_debugging_guide_251127.md
3. session_5_overview_251127.md
4. session_6_roadmap_251127.md

**Foco QA/Soporte**
1. session_5_debugging_guide_251127.md
2. session_5_summary_251127.md (sección de pruebas)
3. session_5_file_manifest_v1.1.0_241126.md (referencias rápidas)

## 🧪 Estado de pruebas
- **Pruebas manuales:** autenticación y flujos básicos verificados; ejemplos curl listos en session_5_debugging_guide_251127.md.
...
- **Variables sensibles:** vivir en `.env` y se consumen en tiempo de arranque; ver session_5_readme_improved_251127.md para detalles.
