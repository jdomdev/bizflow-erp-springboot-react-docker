...
## Documentación
- Estudiamos environment-switch-guide.md para comprender el flujo actual de perfiles y sugerimos mejoras (tabla resumen, orden operativo, claridad sobre seeds).
