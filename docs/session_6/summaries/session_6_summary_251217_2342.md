...
- Se creó `application-test.properties`, alineando el perfil test con el servicio `erp-test-db-container:5432` y replicando las credenciales dedicadas (`erp_test_user / testpassword`) junto con `spring.jpa.hibernate.ddl-auto=update`.
