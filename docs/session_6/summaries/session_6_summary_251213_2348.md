...
**Validación:**
- Creado el script de inicialización `scripts/data/init_expense_data.sh` para poblar datos de gastos
...
├── environment-switch-guide.md
├── automated-db-initialization-sequence.md
...
**`environment-switch-guide.md`** (350 líneas)
...
**Scripts Protegidos:**
- `scripts/data/init_expense_data.sh` - Contiene token JWT de admin Ada Lovelace
- `scripts/users/register_users.sh` - Contiene contraseñas de usuarios
- `scripts/users/register_users_test.sh` - Contiene credenciales de test
- `scripts/tests/run_backend_tests.sh` - Contiene tokens de autenticación
...
# Crea: build/backend/bizflowerp-1.1.0.jar
```
...
bash scripts/data/init_expense_data.sh
...
- **Guía de Entornos:** `/docs/guides/environment-switch-guide.md`
