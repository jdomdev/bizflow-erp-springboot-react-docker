...
# 🏦 ExpenseNoteApp - Expense Management System
...
│   ├── 2025-11-27-6-roadmap.md    # Roadmap Sesión 6
│   ├── 2025-11-27-5-architecture.md          # Arquitectura detallada
│   └── 2025-11-27-5-debugging-guide.md       # Guía de debugging
│
...
### Arquitectura
Ver [2025-11-27-5-architecture.md](2025-11-27-5-architecture.md) para diagrama completo, capas, patrones de diseño y flujos de datos.

### Sesión 5 - Autenticación Implementada
Ver [2025-11-27-5-summary.md](2025-11-27-5-summary.md) para resumen detallado, bugs resueltos, testing realizado.

### Sesión 6 - Roadmap (Próximas Funcionalidades)
Ver [2025-11-27-6-roadmap.md](2025-11-27-6-roadmap.md) para especificaciones de dashboard, gestión de gastos, y testing.

### Debugging y Troubleshooting
Ver [2025-11-27-5-debugging-guide.md](2025-11-27-5-debugging-guide.md) para errores comunes, logs, y soluciones.
...
Ver [2025-11-27-5-debugging-guide.md](2025-11-27-5-debugging-guide.md) para más soluciones.
...
1. **Leer documentación:**
  - [2025-11-27-5-architecture.md](2025-11-27-5-architecture.md) - Entender la arquitectura
  - [2025-11-27-5-summary.md](2025-11-27-5-summary.md) - Saber qué se implementó
...
3. **Desarrollo Sesión 6:**
  ...
  - Ver [2025-11-27-6-roadmap.md](2025-11-27-6-roadmap.md)
